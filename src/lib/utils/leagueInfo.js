...
export const homepageText = `
  <iframe src="https://discord.com/widget?id=181964913021812736&theme=dark" width="350" height="500" allowtransparency="true" frameborder="0" sandbox="allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts"></iframe>
  `;
...
//       "mode": "Balanced", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
...
//       "tookOver": 2020, // (optional) used if a manager took over a team, delete this line or change to null otherwise
      ...
      "fantasyStart": 0004, // (optional) when did the manager start playing fantasy football
